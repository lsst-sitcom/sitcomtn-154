...
include all spectroscopic and grism galaxies in the ``match\_ecfds'' catalog, without applying 
the confidence cut, and only required SNR $>= 5$ in the $i$ band (using \code{psf} fluxes).   
They also drop all galaxies with NaN magnitude in any of the six bands.
We randomly selection 7,000 objects for the \dataset{train\_v1} and used the remaining 2,438 for the 
