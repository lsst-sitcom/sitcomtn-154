...
Finally, Fig.~\ref{fig:dp_color_v_color} shows the color-color plots for the same.  In all cases, the 1.0 arc-second aperture magnitudes are used for plotting.
...
We encourage readers who undertake their own customized \photoz production to investigate the details of each survey that comprise our reference quality and apply their own quality cuts as suit their needs.
