...
\item{\selection{match\_ecdf_v2}: updated matching to high-quality redshift datalogs in the ECDFS field, see Sec.~\ref{sec:data:reference}.}  
...
we have update the note to use the \dataset{train\_v4} and \dataset{test\_v4} datasets.
