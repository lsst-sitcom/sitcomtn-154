...
\input{meta}
\setDocDOI{10.71929/rubin/2571480}
...
\setDocChangeRecord{%
  ...
  \addtohist{2}{2025-07-15}{Updated to use same dp1\_v4 version of
    test / training data sets as the DESC collaboration RAIL
    paper. }{Eric Charles}  
  \addtohist{3}{2025-11-07}{Revise PZ Server access instructions and examples}{Julia Gschwend}
}
